<div class="p-16">
	<div class="p-8 bg-white shadow mt-24">
		<div class="grid grid-cols-1 md:grid-cols-3">
			...
			<div class="relative">
				<div
					class="w-48 h-48 bg-[#2B3148] mx-auto rounded-full shadow-2xl absolute inset-x-0 top-0 -mt-24 flex items-center justify-center text-indigo-500"
				>
					<!-- <svg
					...
					<a href="/" class="hover:transform hover:scale-110 hover:-rotate-6 transition"
						><img src={logo_white} alt="" srcset="" class="w-32" /></a
					>
				</div>
			</div>
		...
		<div class="mt-20 text-center border-b pb-12">
			<h1 class="text-4xl font-medium text-gray-700">
				Praanjal Wason, <span class="font-light text-gray-500">20</span>
			</h1>
			<p class="font-light text-gray-600 mt-3">Delhi, India</p>
			<p class="mt-8 text-gray-500">Cloud Architect - Amazon Web Services</p>
			<p class="mt-2 text-gray-500">Bennett University</p>
		</div>
